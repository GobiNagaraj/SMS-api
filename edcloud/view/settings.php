	 ...
	 ?>
		<form action="../controller/admin_controller.php" method="POST"> 
			<div class="form-group">
				<label> Name </label>
				<div class="col-sm-4">
					<input type="text" name="sms_user" class="form-control" value=<?php echo $value['sms_user']; ?>>	
				</div>
			</div>
			<div class="form-group">
				<label> Number </label>
				<div class="col-sm-4">
					<input type="text" name="sms_password" class="form-control" value=<?php echo $value['sms_password']; ?>>	
				</div>
			</div>
			<div class="form-group">
				<label> Sender ID </label>
				<div class="col-sm-4">
					<input type="text" name="sms_sender_id" class="form-control" value=<?php echo $value['sms_sender_id']; ?>>	
				</div>
			</div>
			<div class="form-group">
